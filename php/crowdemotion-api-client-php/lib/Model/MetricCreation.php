...
/**
 * MetricCreation Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MetricCreation implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'MetricCreation';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['metric_type'] === null) {
            $invalid_properties[] = "'metric_type' can't be null";
        }
